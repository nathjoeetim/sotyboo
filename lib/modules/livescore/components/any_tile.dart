...
class AnyTile extends StatefulWidget {
  AnyTile({
    Key? key,
    required this.logo,
    required this.title,
  ...
  @override
  State<AnyTile> createState() => _AnyTileState();
}

class _AnyTileState extends State<AnyTile> {
  @override
      ...
      child: Row(
        children: [
          SizedBox(
            height: 20.h,
            width: 28.h,
            child: Image.asset('assets/images/${widget.logo}.png'),
          ),
          SizedBox(width: 16.h),
          Column(
